...
| [`10-release-v0.3.md`](10-release-v0.3.md) | **Current release (tag v0.3.0)** — Salamandra r1 airfoil coordinates, aircraft-equilibrium propulsion and binding Article #1 mass/CG allocation |
