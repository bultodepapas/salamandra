...
| [`17-article-1-hardware-manifest.md`](17-article-1-hardware-manifest.md) | **MP-03 candidate hardware and power interface** — 22-row 6S-R/CLEAN manifest, separate 8S study architecture, equipment mass/uncertainty, rail capacities and H01–H22 physical closure queue (`calculations/hardware_manifest.py`) |
