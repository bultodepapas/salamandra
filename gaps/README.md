...
| **G10** | **Directional stability Cnβ** — finless baseline estimated negative (FSW + nose boom); the fin/no-fin choice is not yet measured | CLEAN is FC-dependent in yaw; twin-fin V1a costs ≈ +13.1% drag `[E]`, has only 0.80 g assembly-allocation margin and needs V1 CG recovery | 🔄 **Bounded, not closed (I-29 `[D]` on independent `[E]` corners)** — finless −0.00055…−0.00141/deg; V1a power-on/off −0.00029…+0.00119; V1b +0.00017…+0.00173. V1a lower corner is not robust | **E8 yaw modal identification**, prop/wake survey, twin-boom/root static test and CAD side-area/mass check (OP-21/26) |
