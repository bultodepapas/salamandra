...
| **G10** | **Directional stability Cnβ** — finless baseline estimated negative (FSW + nose boom); the fin/no-fin choice is not yet measured | CLEAN is FC-dependent in yaw; V1a costs ≈ +10.2 % energy `[E]` and requires an open 84.1 mm carrier | 🔄 **Bounded, not closed (I-20 `[D]` on independent `[E]` corners)** — finless −0.0006…−0.0014/deg; V1a powered −0.00029…+0.00119 and motor-off −0.00057…+0.00087; neither tier is robust at the full motor-off lower corner | **E8 yaw perturbation/modal identification**, partial-wake survey and CAD side-area/carrier check (OP-21/26) |
