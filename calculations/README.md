...
| `mutation_test.py` | **Proof that the suite can fail** — seeds 23 deliberate defects (missing hardware/governance records, sign flips, dropped normalisations, desynchronised copies and defeated OML predicates) and requires each to turn at least one contract check red (C43) | Whole system, CI | stdlib only |
