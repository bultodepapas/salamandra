...
|---|---|---|---|---|
| **OP-01** | **CG reachability** | Target CG −93.8 mm. CLEAN E01 solution −337.74 mm is inside travel. Coupled V1 adds 17.81 mm of nose travel and 2.40 g support, solving battery x −386.74 mm and exact target xCG in two iterations. This is analytical, not physical closure. | Real mass properties, support stiffness and central-body NP; verify V1 station/travel with the built carrier | F2/P1–P3; first-print balance |
...
| # | Item | v0.4 value | What changes it | Trigger |
|---|---|---|---|---|
| OP-16 | Battery carrier (cradle) | Printed 2 halves, CLEAN/V1 **201.0/218.81 mm**, inner cross-section **68×25 mm**, E01 envelope 153.0×65.7×22.6 mm; CLEAN/V1 centres −337.74/−386.74 mm; Ø8.2 channel | Verify the calculated 17.81 mm V1 extension, 16.33 g cradle and real-pack travel in CAD/assembly | F2/P3 |
...
| **OP-24** | **Measured mass acceptance** | CLEAN **1553.25 g / 44.1 km/h**; coupled twin-fin V1 **1615.63 g / 44.93 km/h**, including the 59.97 g fin/boom module and 2.40 g forward-support addition. Analytical margin to the exact C16 ceiling is only about 4.8 g; final fillet/saddle/support mass is not measured. | CAD mass properties and complete-aircraft scale measurement; reject V1 >1620.4 g unless E2 re-derives CLmax | F2/P3; first complete assembly |
...
| **OP-26** | **Twin-fin V1 verification (ADR-0038, I-29/I-30)** | V1a total **3.4737 dm²**; two 186.4 mm fins with 128.5/57.8 mm chords, taper 0.45, LE 25° and Λc/4 20.379°. Two 18×14 mm boom envelopes at y ±140 mm give 29.4 mm nominal / 13.4 mm residual prop clearance after the 16.0 mm allowance. Root **3.0 mm solid** gives FS 4.45 without spar credit; mode ≈14.6 Hz. Complete lower mass 59.97 g leaves 0.03 g allocation margin. V1a lower Cnβ corner remains negative; V1b 4.63 dm² is positive-corner but mass-open. | CAD boom/saddle load path, powered runout/wake survey, fin flutter/static test, mass/CG compensation, E8 yaw modal identification | F2/F4-S8; E8 |
