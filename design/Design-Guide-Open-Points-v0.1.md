...
|---|---|---|---|---|
| **OP-01** | **CG reachability** | **Re-derived with twin-fin/boom mass centres:** target CG −93.8 mm. CLEAN E01 solution −337.74 mm is inside travel −371.20…−336.10 mm. V1 requires **−389.67 mm** and clamps 18.47 mm short; xCG −88.686 mm misses the aft band edge by 0.094 mm. Cradle inner section 68×25 mm; overall length 201 mm. | Real mass properties and central-body NP; recover V1 station through measured forward mass placement or approved travel | F2/P1–P3; first-print balance |
...
| # | Item | v0.4 value | What changes it | Trigger |
|---|---|---|---|---|
| OP-16 | Battery carrier (cradle) | Printed 2 halves, **201 mm overall**, inner cross-section **68×25 mm**, 6S1P P42A E01 envelope 153.0×65.7×22.6 mm; CLEAN centre −337.74 mm, twin-fin V1 required **−389.67 mm** versus −371.20 mm stop; Ø8.2 channel gripping the boom | R-CG verification and 18.47 mm V1 travel/mass-placement recovery in CAD with real packs | F2/P3 |
...
| **OP-24** | **Measured mass acceptance** | CLEAN **1553.25 g / 44.1 km/h**; twin-fin V1 allocation **1613.25 g** and connected lower model **1612.45 g / 44.9 km/h** including both shells/mounts, spars and aft booms. Analytical margin to the exact C16 ceiling is only about 7.9 g; final fillet/saddle mass is not measured. | CAD mass properties and complete-aircraft scale measurement; reject V1 >1620.4 g unless E2 re-derives CLmax | F2/P3; first complete assembly |
...
| **OP-26** | **Twin-fin V1 verification (ADR-0038, I-29)** | V1a total **3.4404 dm²**; two 185.5/142.7/42.8 mm fins, vertical TE, taper 0.30 and Λc/4 21.991°. Two 18×14 mm boom envelopes at y ±140 mm give 29.4 mm inner prop clearance. Root **3.0 mm solid** gives FS 5.34 without spar credit; mode ≈14.7 Hz. Complete lower mass 59.20 g leaves 0.80 g allocation margin. V1a lower Cnβ corner remains negative; V1b 4.58 dm² is positive-corner but mass-open. | CAD boom/saddle load path, prop/wake survey, fin flutter/static test, mass/CG compensation, E8 yaw modal identification | F2/F4-S8; E8 |
