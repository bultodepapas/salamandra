...
| # | Item | v0.4 value | What changes it | Trigger |
|---|---|---|---|---|
| OP-16 | Battery carrier (cradle) | Printed 2 halves, CLEAN/V1 **201.0 mm**, inner cross-section **68×25 mm**, E01 envelope 153.0×65.7×22.6 mm; CLEAN/V1 centres −337.74/−363.27 mm; Ø8.2 channel | Verify the unchanged 15.0 g cradle and real-pack travel in CAD/assembly | F2/P3 |
...
| **OP-24** | **Measured mass acceptance** | CLEAN **1553.25 g / 44.1 km/h**; coupled twin-fin V1 **1601.98 g / 44.74 km/h**, including the 48.73 g fin/support module and no forward-support addition. Analytical margin to the exact C16 ceiling is about 18.4 g; final fillet/saddle/support mass and foamed density are not measured. | CAD mass properties and complete-aircraft scale measurement; reject V1 >1620.4 g unless E2 re-derives CLmax | F2/P3; first complete assembly |
...
| **OP-26** | **Twin-fin V1 verification (ADR-0038, I-29/I-30)** | V1a total **6.1437 dm²**; two 247.9 mm fins with 170.9/76.9 mm chords, taper 0.45, LE 20° and Λc/4 15.064°. Fins are CORE-rooted at y ±140 mm and retain zero axial overlap, 8.33 mm controlling axial residual, and 13.4 mm radial residual to the inflated propeller hazard. Root **3.0 mm solid** gives FS 2.52 without spar credit; mode ≈8.2 Hz. Complete lower mass 48.73 g leaves 11.27 g allocation margin using LW-PLA-HT at 620 kg/m³. V1a lower Cnβ corner remains negative; V1b 8.18 dm² is positive-corner but mass-open. | CAD root-support load path, LW-PLA-HT coupon density/strength, powered runout/wake survey, fin flutter/static test, mass/CG compensation, E8 yaw modal identification | F2/F4-S8; E8 |
