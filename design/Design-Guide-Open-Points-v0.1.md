...
|---|---|---|---|---|
| **OP-01** | **CG reachability** | **Re-derived with the corrected V1 fin mass centres:** target CG −93.8 mm. CLEAN E01 solution −337.74 mm is inside travel −371.20…−336.10 mm. V1 requires −375.48 mm and clamps 4.28 mm short; xCG −92.59 mm remains inside band. Cradle inner section 68×25 mm; overall length 201 mm. | Real mass properties and central-body NP; recover or accept V1 station | F2/P1–P3; first-print balance |
...
| # | Item | v0.4 value | What changes it | Trigger |
|---|---|---|---|---|
| OP-16 | Battery carrier (cradle) | Printed 2 halves, **201 mm overall**, inner cross-section **68×25 mm**, 6S1P P42A E01 envelope 153.0×65.7×22.6 mm; CLEAN centre −337.74 mm, V1 required −375.48 mm versus −371.20 mm stop; Ø8.2 channel gripping the boom | R-CG verification and V1 travel recovery in CAD with real packs | F2/P3 |
...
| **OP-24** | **Measured mass acceptance** | ADR-0045 baseline: CLEAN **1553.25 g / 44.1 km/h**; V1 allocation 1589.97 g and connected lower model **1595.80 g / 44.7 km/h** including the 42.55 g fin lower model. Analytical margin to the exact C16 ceiling is about 24.6 g, but the corrected 84.1 mm carrier mass is not closed. Only 6 g balance saving is credited; fixed bridge PETG remains in the shell. | CAD mass properties and complete-aircraft scale measurement; reject V1 >1620.4 g unless E2 re-derives CLmax | F2/P3; first complete assembly |
...
| **OP-26** | **Fin variant V1 verification (ADR-0038, I-20)** | V1a **2.1025 dm²**, 251.1/104.6/62.8 mm, vertical TE and Λc/4 7.125°; V1b **2.80 dm²**, 290/121/72 mm. Root **3.0 mm solid** gives FS 1.69 without spar credit; mode ≈8.0 Hz. Ø3 mm Al rod is an external LE nose in an open seat. C32 complete lower mass 42.55 g exceeds its 36.72 g allocation by 5.83 g; carrier mass is open. Both tiers have a negative full motor-off lower corner. | CAD side area and 84.1 mm carrier, partial-wake survey, fin flutter test, mass compensation, E8 yaw perturbation/full modal identification | F2/F4-S8; E8 |
