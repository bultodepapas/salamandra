# ADR-0043 — Article #1 mass allocation closes the 45 km/h stall target

**Status:** ✅ Active design allocation · **Date:** 2026-08-17 · **Confidence:** Medium `[M]`/`[D]`/`[E]` · **Reversible:** Yes
**Research:** I-16…I-19, I-22 · **Verification:** F2 CAD mass properties and weighed assembly
...
| V1a fin | **≤ 36.72 g** | lower bound of the current 36.72–61.20 g model; CAD acceptance cap `[E]` |
...
| SALAMANDRA-V1 | **1,620.2 g** | 57.5 g/dm² | **45.0 km/h** |

The formula's exact 45 km/h mass ceiling is 1,620.4 g. CLEAN therefore carries 36.9 g
of allocation margin; V1 carries only 0.2 g and must be weighed. The lighter component
...
- OP-24 closes as a design allocation. It does not close the F2 measurement: a CAD or
  built assembly above its cap is rejected or must be re-derived against measured E2
  `CLmax`.
