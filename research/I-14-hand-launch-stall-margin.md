...
require of the stall speed and thrust — for the 1553.25 g CLEAN / 1595.80 g V1
lower-model wing?
...
ADR-0045. The fin remains 5.83 g over its internal allocation; the corrected carrier mass is open and physical F2/E2
...
| Quantity | Value |
|---|---:|
| V_stall (V1 lower model 1595.80 g / CLEAN 1553.25 g) | **44.7 / 44.1 km/h** (12.4 / 12.2 m/s) |
...
2. **Stall-margin policy (C16 chain):** CLEAN closes at 44.1 km/h and the C32/ADR-0045
   V1 lower model closes analytically at 1595.80 g / 44.7 km/h before the open carrier mass. F2 must still verify
   actual aircraft mass, the fin's 5.83 g internal allocation gap and the V1 battery
