...
> **Article #1 geometry update (2026-08-18):** I-27/ADR-0045 shortens the moving
> surface to 35–90 % half-span and moves each servo to y = ±406.25 mm. The current
> values below are generated by `servo_torque.py`; the catalog itself is unchanged.
...
The reference aircraft now uses **2 digital servos** (one per elevon) on **357.5 mm
elevons** (35–90 % half-span, 0.28 c, hinge at 0.72 c). ADR-0026 was corrected on
...
| **Article #1 mass = 12.5 g/servo** | guide §7.5 / ADR-0043 | Selected pair is 25.0 g total; 15 g remains a catalog comparison class |
...
| Elevon: aerodynamic mean chord / span | 56.4 mm / 357.5 mm | `[D]` |
| Control area S_control (each elevon) | **199 cm²** | `[D]` |
| Design speed V | 180 km/h (50 m/s) | `[D]` (guide design 180) |
| **Hinge moment per elevon** | **17–86 mN·m** (Ch 0.01–0.05) | `[D]`+`[E]` |
| **Per servo (one complete elevon)** | **17–86 mN·m (0.18–0.88 kgf·cm)** | `[D]`+`[E]` |

> **Fact for the designer:** even the most modest catalog servo below
> (MG90S ≈ 1.8 kgf·cm) has **2.05× ideal margin** on the worst per-servo
> hinge-moment case. With a 1.5 safety factor and 80 % linkage efficiency, the
> required catalog torque is **1.643 kgf·cm**; the Article #1 Corona DS-939MG at
> 2.5 kgf·cm has **1.52× factored margin at 180 km/h** and about 4.5× at the
...
a ~0.28 c elevon on this class of wing is approximately 0.88 kgf·cm per elevon at
...
| Servo | Meets 15 g/servo? | Digital | Meets 1.643 kgf·cm factored demand @ 180 km/h | Price class |
|---|---|---|---|---|
| TBS Mojito (reference) | no (19 g) | ✓ | ✓ (1.95× at 3.2 kgf·cm) | ~€20 |
| TowerPro MG90S | ✓ (13.4 g) | ✓ | ✓, but only 1.10× at 4.8 V / 1.34× at 6 V | US$2.5–5 |
| Emax ES09MD | ✓ (13.5–14.8 g) | ✓ | ✓ | US$12.5–18 |
| Corona DS-939MG | ✓ (12.5 g) | ✓ | ✓ | US$12.5 |
| Hitec HS-5055MG | ✓ (9.5 g) | ✓ | No (1.3–1.6 kgf·cm) | — |
| Savox SH-0255MG+ | no (15.8 g) | ✓ | ✓ | — |
...
> column**: Article #1 selects the 12.5 g Corona pair. The digital-metal-gear
> 12–15 g class is broadly compatible, but anything above 12.5 g/servo consumes
> mass margin unless another row is reduced. The separate moving-surface balance
> allocation is 54 g total (ADR-0025/0045).
